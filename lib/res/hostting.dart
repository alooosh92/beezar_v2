...
class Hostting {
  ...
  static Uri getPolicy = Uri.parse("$api/showPolicy");
  static Uri updateUserNew = Uri.parse("$api/updateInfoUser");
  ...
  static Uri getMassege = Uri.parse("$api/show-comments-user");
}
